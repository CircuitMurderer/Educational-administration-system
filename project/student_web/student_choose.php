...
{
    echo '<form method="post" action="chose_process.php" id="chosenCourses">';
...
<div class="wrapper">
    <main>
        ...
        <div class="calendar">
            <?php
            $qy = <<<QUERY
                SELECT cid, c_name, t_name, t_dept, credit 
                FROM course, teacher
                WHERE NOT EXISTS(
                    SELECT * FROM chose_course
                    WHERE sid = '{$uid}'
                    AND course.cid = chose_course.cid
